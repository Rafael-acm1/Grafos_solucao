...
public class Main {
    public static void main(String[] args) throws IOException {
        ...
        System.out.println("");
        System.out.println("Sendo o vertice A1 a cidade de Buíque(Cidade inicial que escolhemos pra modelagem do problema), as encanações devem seguir o seguinte caminho para abastecer todos os sítios de maneira otimizada:");
        System.out.println("");
